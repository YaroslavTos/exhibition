...
class userMap extends BaseMap
{
    ...
    public function findProfileById($id=null){
        if ($id) {
            $res = $this->db->query("SELECT user.user_id, name,". " user.birthday, gender.name AS gender ". "INNER JOIN gender ON user.gender_id=gender.gender_id WHERE user.user_id = $id");
